...
namespace SGL.Analytics.Client {
	...
	public class UserRegistrationRestClientOptions {
		...
		/// <summary>
		/// The default relative API route for the user registration, <c>api/AnalyticsUser</c>.
		/// </summary>
		public const string UserRegistrationApiRouteDefault = "api/AnalyticsUser";
		/// <summary>
		/// The default relative API route for the login, <c>api/AnalyticsUser/login</c>.
		/// </summary>
	...
	public class UserRegistrationRestClient : IUserRegistrationClient {
		...
		/// <summary>
		/// Creates a client object that uses the given base URI of the backend server and the standard API URIs, <c>api/AnalyticsUser</c> for registration, and <c>api/AnalyticsUser/login</c> for login.
		/// </summary>
		...
		/// </summary>
		/// <param name="backendServerBaseUri">The base URI of the backend server, e.g. <c>https://sgl-analytics.example.com/</c>.</param>
		/// <param name="userRegistrationApiRoute">The relative URI under <paramref name="backendServerBaseUri"/> to the user registration API endpoint, e.g. <c>api/AnalyticsUser</c>.</param>
		/// <param name="loginApiRoute">The relative URI under <paramref name="backendServerBaseUri"/> to the login API endpoint, e.g. <c>api/AnalyticsUser/login</c>.</param>
