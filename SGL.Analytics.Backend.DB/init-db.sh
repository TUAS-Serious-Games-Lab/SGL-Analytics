...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB"<<-EOSQL
	...
	GRANT SELECT, INSERT, UPDATE ON ALL TABLES IN SCHEMA public TO sgla_users;
	GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO sgla_users;
	...
	GRANT SELECT, INSERT, UPDATE ON ALL TABLES IN SCHEMA public TO sgla_logs;
	GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO sgla_logs;
EOSQL
