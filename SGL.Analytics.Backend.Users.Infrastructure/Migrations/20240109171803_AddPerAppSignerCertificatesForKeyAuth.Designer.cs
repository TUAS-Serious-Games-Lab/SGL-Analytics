...
namespace SGL.Analytics.Backend.Users.Infrastructure.Migrations
{
    ...
    [Migration("20240109171803_AddPerAppSignerCertificatesForKeyAuth")]
    partial class AddPerAppSignerCertificatesForKeyAuth
    {
		/// <inheritdoc/>
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGL.Analytics.Backend.Domain.Entity.SignerCertificate", b =>
                {
                    b.Property<Guid>("AppId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SignerCertificates", (string)null);
                });
            ...
            modelBuilder.Entity("SGL.Analytics.Backend.Domain.Entity.ApplicationWithUserProperties", b =>
                {
                    ...
                    b.Navigation("SignerCertificates");
